...
import { X, Target, Calendar, Tag, Plus } from 'lucide-react';
...
export default function SimpleCreateGoalModal({ isOpen, onClose }) {
  ...
  return (
    <Dialog as="div" className="fixed inset-0 z-50" onClose={handleClose} open={isOpen}>
                ...
                <div className="space-y-2">
                  <div className="flex space-x-2">
                    ...
                    <input
                      ...
                      placeholder="🎯"
                      className="w-16 px-3 py-2 border border-gray-300 rounded-lg text-center focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    />
                    <input
                      type="color"
